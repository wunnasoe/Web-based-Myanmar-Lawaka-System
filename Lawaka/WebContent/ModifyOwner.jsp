...
<title>အလွှာရှင် မှတ်တမ်းပြင်ဆင်ခြင်း</title>
<style type="text/css">
body {
...
<body>
 ...
 <form action="OwnerUpdate" method="post" accept-charset="utf-8" enctype="multipart/form-data" name="ownerRegistration">
  <table cellpadding="10">
  <tr><td><label for="serial">Serial အမှတ်</label></td>
 <td><%=serial_no %> </td><td></td>
...
<td> <input type="text"  name="issuedDate" ></td> <td></td>
