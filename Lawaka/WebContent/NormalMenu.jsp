...
<title>Normal</title>
<style>
body {background: url("images/photo_bg.jpg") no-repeat center center fixed;
...
<div class="tab">
  <button class="tablinks" onclick="openTab(event, 'Store')">မှတ်တမ်း အသစ် သိမ်းရန်</button>
  <button class="tablinks" onclick="openTab(event, 'Search')">မှတ်တမ်းအဟောင်း ရှာရန်</button>
