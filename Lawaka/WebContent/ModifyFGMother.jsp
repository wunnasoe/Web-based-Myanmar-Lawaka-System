...
<title>ဘဘွား မှတ်တမ်းပြင်ဆင်ခြင်း</title>
<style type="text/css">
body {
...
<form action="FGMotherUpdate" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<table cellpadding="10">
<tr><td><label for="fgrandmotherName">ဖဘွားအမည်</label> </td><td><input type="text" name="fgrandmotherName"> </td><td> </td>
<td><label for="date_of_birth">မွေးသက္ကရဇ်</label> </td><td><input type="text" name="date_of_birth">  </td> </tr>
<tr><td><label for="nrc_no">ဖဘွား၏ နိုင်ငံသားစီစစ်ရေး ကဒ်ပြား အမှတ်</label> </td><td><input type="text" name="nrc_no"> </td><td> </td>
