...
/**
 * Servlet implementation class MGrandFatherRecordStoreAction
 */
@WebServlet("/MGFatherRecordStore")
@MultipartConfig(maxFileSize = 16177216)
public class MGrandFatherRecordStoreAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MGrandFatherRecordStoreAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			result = InsertRecords.insertMGrandFatherRecord(mother);
