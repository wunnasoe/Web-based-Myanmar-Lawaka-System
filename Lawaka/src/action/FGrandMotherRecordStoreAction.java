...
/**
 * Servlet implementation class FGrandMotherRecordStoreAction
 */
@WebServlet("/FGMotherRecordStore")
@MultipartConfig(maxFileSize = 16177216)
public class FGrandMotherRecordStoreAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FGrandMotherRecordStoreAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			result = InsertRecords.insertFGrandMotherRecord(mother);
