...
/**
 * Servlet implementation class MGrandMotherRecordStoreAction
 */
@WebServlet("/MGMotherRecordStore")
@MultipartConfig(maxFileSize = 16177216)
public class MGrandMotherRecordStoreAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MGrandMotherRecordStoreAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			result = InsertRecords.insertMGrandMotherRecord(mother);
		...
		if(result==1){
			...
			response.sendRedirect("SuccessRecordStore.jsp");
		}
	}
