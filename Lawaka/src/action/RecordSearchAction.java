...
/**
 * Servlet implementation class RecordSearchAction
 */
@WebServlet("/RecordSearch")
public class RecordSearchAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RecordSearchAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Boolean role = (Boolean)s.getAttribute("role");
		ArrayList<OwnerRecordForm> resultList = new ArrayList<OwnerRecordForm>();
			...
			s.setAttribute("resultList", resultList);
