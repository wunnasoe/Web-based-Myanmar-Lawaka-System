...
/**
 * Servlet implementation class FGrandFatherRecordStoreAction
 */
@WebServlet("/FGFatherRecordStore")
@MultipartConfig(maxFileSize = 16177216)
public class FGrandFatherRecordStoreAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FGrandFatherRecordStoreAction() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			result = InsertRecords.insertFGrandFatherRecord(mother);
